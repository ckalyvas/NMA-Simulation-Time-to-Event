...
# 'res'
saveRDS(combined_results, file = "/hpc/leinehome/spinelil/Survival_NMA_simulation/Output_FP/Simulation_FP_results_ECOG.rds") 

# 'd_draws_ipd'
saveRDS(d_draws_ipd_res, file = "/hpc/leinehome/spinelil/Survival_NMA_simulation/Output_FP/Simulation_FP_draws_ipd_ECOG.rds") 

# 'd_draws_aggd'
saveRDS(d_draws_aggd_res, file = "/hpc/leinehome/spinelil/Survival_NMA_simulation/Output_FP/Simulation_FP_draws_aggd_ECOG.rds") 
