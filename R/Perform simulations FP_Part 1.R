...
#*                   <Fractional polynomial - Uninformative>                                 
#*
#*
#*******************************************************************************
...
#source("E:/Survival_NMA_simulation/Simulation FP_function_v2.R")
#source("E:/Survival_NMA_simulation/Functions_collection.R")
...
# 'res'
saveRDS(combined_results, file = "/hpc/leinehome/spinelil/Survival_NMA_simulation/Output_FP/Simulation_FP_results_uninfcens.rds") 

# 'd_draws_ipd'
saveRDS(d_draws_ipd_res, file = "/hpc/leinehome/spinelil/Survival_NMA_simulation/Output_FP/Simulation_FP_draws_ipd_uninfcens.rds") 

# 'd_draws_aggd'
saveRDS(d_draws_aggd_res, file = "/hpc/leinehome/spinelil/Survival_NMA_simulation/Output_FP/Simulation_FP_draws_aggd_uninfcens.rds") 
